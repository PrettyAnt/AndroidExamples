...
import com.example.androidexample.ui.WebTelActivity;
 ...
 * describle :
 */
public class ZxkfNotifiBuilder {
    ...
    private static final ZxkfNotifiBuilder   ourInstance = new ZxkfNotifiBuilder();
    ...
    private ZxkfNotifiBuilder() {
    }

    public static ZxkfNotifiBuilder with(Context sContext) {
        context = sContext;
        return ourInstance;
    }
     ...
     * 创建服务通知
     */
    public ZxkfNotifiBuilder buidForegroundNotification() {
...
// builder.setWhen(System.currentTimeMillis());
        //设置启动的内容
        Intent intent = new Intent(context, WebTelActivity.class);
...
// builder.setChannelId("1");
     ...
     * 创建通知渠道
     */
    public ZxkfNotifiBuilder buidNotificationChannel() {
...
//        manager.notify(notificationId, notification);
     ...
     * 开启震动
     */
    public ZxkfNotifiBuilder shakePhone(boolean isOpen) {
        if (!isOpen) {
            return this;
        }
...
//            vibrator.cancel();
     ...
     * @return
     */
    public ZxkfNotifiBuilder start(Service service) {
        if (notification == null) {
            return this;
        }
