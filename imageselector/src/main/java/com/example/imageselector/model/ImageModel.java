...
public class ImageModel {
        ...
        if (mCursor != null) {
            while (mCursor.moveToNext()) {
                ...
                String name = mCursor.getString(
                        mCursor.getColumnIndexOrThrow(MediaStore.Images.Media.DISPLAY_NAME));
                //获取图片时间
                ...
                String mimeType = mCursor.getString(
                        mCursor.getColumnIndexOrThrow(MediaStore.Images.Media.MIME_TYPE));
    ...
    private static Folder getFolder(String name, java.util.List<Folder> folders) {
        if (!folders.isEmpty()) {
