...
public class ImageAdapter extends RecyclerView.Adapter<ImageAdapter.ViewHolder> {
    ...
    private void setItemSelect(ViewHolder holder, boolean isSelect) {
        if (isSelect) {
            ...
            holder.tv_item_checked.setBackgroundResource(R.drawable.shape_check_background);
            holder.tv_item_checked.setText(String.valueOf(mSelectImages.size()));
            holder.tv_item_checked.setVisibility(View.GONE);
        } else {
            index--;
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            tv_item_checked = itemView.findViewById(R.id.tv_item_checked);
