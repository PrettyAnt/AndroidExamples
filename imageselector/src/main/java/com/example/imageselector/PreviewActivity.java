...
public class PreviewActivity extends AppCompatActivity {
    ...
    private android.widget.TextView tvIndicator;
    ...
    private void initListener() {
        ...
        tvSelect.setOnClickListener(new android.view.View.OnClickListener() {
            @Override
            public void onClick(android.view.View v) {
                clickSelect();
            }
    ...
    private void setStatusBarVisible(boolean show) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            if (show) {
                getWindow().getDecorView().setSystemUiVisibility(android.view.View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN);
            } else {
                getWindow().getDecorView().setSystemUiVisibility(android.view.View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN
                ...
                if (rlTopBar != null) {
                    ...
                    animator.addListener(new AnimatorListenerAdapter() {
                        ...
                        public void onAnimationStart(Animator animation) {
                            ...
                            if (rlTopBar != null) {
                                rlTopBar.setVisibility(android.view.View.VISIBLE);
                            }
                        }
                    });
                    animator.start();
    ...
    private void hideBar() {
        ...
        animator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (rlTopBar != null) {
                    rlTopBar.setVisibility(android.view.View.GONE);
