...
public class ClipImageView extends AppCompatImageView {
    ...
    private void init() {
        ...
        mTempMatrix = new android.graphics.Matrix();
        mFrontGroundPaint.setColor(android.graphics.Color.parseColor("#ac000000"));
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        float left   = values[android.graphics.Matrix.MTRANS_X];
        float top    = values[android.graphics.Matrix.MTRANS_Y];
        float right  = (left + mBitmapWidth * values[android.graphics.Matrix.MSCALE_X]);
        float bottom = (top + mBitmapHeight * values[android.graphics.Matrix.MSCALE_Y]);
        float x      = 0f;
        float y      = 0f;
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (CURR_MODE == MODE_DRAG || CURR_MODE == MODE_POINTER_UP) {
                    ...
                    if (distance > 10f) {
                        ...
                        float temp_left   = temp_values[android.graphics.Matrix.MTRANS_X];
                        float temp_top    = temp_values[android.graphics.Matrix.MTRANS_Y];
                        float temp_right  = (temp_left + mBitmapWidth * temp_values[android.graphics.Matrix.MSCALE_X]);
                        float temp_bottom = (temp_top + mBitmapHeight * temp_values[android.graphics.Matrix.MSCALE_Y]);
                        //靠边预判断
