...
import com.example.imageselector.utils.UriUtils;
...
public class ImageSelectorActivity extends AppCompatActivity {
    ...
    private android.widget.TextView tvFolderName;
    ...
    private String         permissionReadMediaImages =Manifest.permission.READ_MEDIA_IMAGES;
    private String         permissionWrite =Manifest.permission.CAMERA;//相机权限
    ...
    private void initView() {
        ...
        checkBox = findViewById(R.id.tv_title_selector);
...
//                rvFolder.setTranslationY(rvFolder.getHeight());
                ...
                rvFolder.setBackgroundColor(android.graphics.Color.WHITE);
            }
        });
    }
    ...
    private void setSelectImageCount(int count) {
        if (count == 0) {
            ...
            if (isSingle) {
                ...
                tvConfirm.setText(getString(R.string.selector_send) + "(" + mMaxCount + "/" + mMaxCount + ")");
                Toast.makeText(this, "最多选择" + mMaxCount + "张图片", Toast.LENGTH_SHORT).show();
            } else {
                tvConfirm.setText(getString(R.string.selector_send) + "(" + (count) + "/" + mMaxCount + ")");
            }
        }
...
//                    rvFolder.setVisibility(android.view.View.VISIBLE);
//                }
//            });
//            animator.start();
            isOpenFolder = true;
...
//                    rvFolder.setVisibility(android.view.View.GONE);
//                }
//            });
//            animator.start();
            isOpenFolder = false;
...
//            Toast.makeText(this, "没有图片", Toast.LENGTH_LONG).show();
        ...
        if (hasWriteExternalPermission == PackageManager.PERMISSION_GRANTED) {
            ...
            ActivityCompat.requestPermissions(ImageSelectorActivity.this,
                    new String[]{permissionReadMediaImages}, PERMISSION_WRITE_EXTERNAL_REQUEST_CODE);
        }
    }
    ...
    private void checkPermissionAndCamera() {
        ...
        if (hasCameraPermission == PackageManager.PERMISSION_GRANTED
            ...
            //没有权限，申请权限。
            ActivityCompat.requestPermissions(ImageSelectorActivity.this,
                    new String[]{Manifest.permission.CAMERA, permissionWrite}, PERMISSION_CAMERA_REQUEST_CODE);
        }
    }
    ...
    private void openCamera() {
        try {
            ...
            Log.e("prettyant", "ImageSelectorActivity-->>openCamera");
        }
    ...
    public Uri createImagePathUri() {
        ...
        SimpleDateFormat timeFormatter = new SimpleDateFormat("yyyyMMdd_HHmmss", java.util.Locale.getDefault());
        ...
        values.put(MediaStore.Images.Media.RELATIVE_PATH, "Pictures/SPDB");
    ...
    private File createImageFile() throws IOException {
        ...
        String imageFileName = String.format("JPEG_%s.jpg", "IMG_" + timeStamp);
