 ...
 * @Date 2019/9/23
 */
public class RequestConfig implements android.os.Parcelable {
    ...
    protected RequestConfig(android.os.Parcel in) {
    ...
    public static final Creator<RequestConfig> CREATOR = new Creator<RequestConfig>() {
        @Override
        public RequestConfig createFromParcel(android.os.Parcel source) {
